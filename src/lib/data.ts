...
/**
 * Every geocoded place as a MapPoint, with city/category names joined in.
 * Single source of truth for the global map (/map) and the "all" KML export —
 * mirrors what /api/map-points returns for the homepage globe overlay.
 */
